            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <center>
                                <a href="/">
                                    <img class="size-10" src="img/logo-muhi.png" alt="Your Company">
                                </a>
                            </center>
                        </div>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button @click="isOpen = !isOpen" type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="size-8 rounded-full" src="img/Rosee.jpg" alt="">
                                    </button>
                                </div>
              ...
              -->
                                <div
                                    ...
                                    <a href="https://instagram.com/umii_khoiriyah" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">My Profile</a>
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="img/Rosee.jpg" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Umi Khoiriyah</div>
                            <div class="text-sm font-medium text-gray-400">ummy90@gmail.com</div>
                        </div>
                       
                    </div>
                    <div class="mt-3 space-y-1 px-2">
                        <a href="https://instagram.com/umii_khoiriyah" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Your Profile</a>
